...
public class UserTubeWrite extends DataMaybe<UserTube> {
    protected String TAG = UserTubeWrite.class.getSimpleName();

    private UserTubeAccess access;
    private UserTube join;
    private Context context;

    public UserTubeWrite(Context context, UserTube join) {
